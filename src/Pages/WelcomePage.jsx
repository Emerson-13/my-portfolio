...
const WelcomePage = () => {
  ...
  const projects = [
      ...
      fullDescription: 'Led the development of Vyblinx as Lead Developer, overseeing system architecture and feature implementation. The platform supports user profiles, posts, reactions, and content sharing. Built with Laravel, Inertia.js, and Vue.js with a focus on scalable architecture and smooth team coordination.',
    ...
    },
    {
      ...
      fullDescription: 'Directed the development of Work4U as Backend API Developer, implementing user accounts, tutor-student matching, scheduling, and session coordination features. Built with Laravel and Blade, designed to be straightforward and accessible for both students and tutors.',
      tags: ['Laravel', 'Blade'],
      github: '',
      demo: ''
    },
    {
      ...
      fullDescription: 'Assisted as Support Developer in building and maintaining a payroll system that handles employee salary computation, payroll records, deductions, and report generation. Developed using Laravel and Blade with a focus on accuracy and reliability.',
      tags: ['Laravel', 'Blade'],
      github: '',
      demo: ''
    },
